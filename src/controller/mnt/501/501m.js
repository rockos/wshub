...
function showPart(req, res, posts) {
    ...
    lcsDb.query(sql, function(err, results, fields) {
            ...
            var msg = lcsAp.getMsgI18N('gc0');
            posts.mesg = msg.text;
            posts.mesg_lavel_color = msg.warn;

            /*
            [posts.mesg, posts.mesg_lavel_color] =
...
var validCheck = {
    ...
    checkDb: function(args, callback) {
        ...
        lcsDb.query(sql, [args.req.body['pcode']],
...
function parseData_add(args, nextExec) {
    ...
    //args.plist = {'pcode','p'};
    lcsAp.series(args,
                 [validCheck.checkParams, validCheck.checkDb,
                     validCheck.filter],
                     finParse);
...
function parseData_del(args, nextExec) {
    ...
    lcsAp.series(args, [validCheck.checkParams_del, validCheck.checkDb],
                 finParse);
