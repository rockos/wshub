...
/* 画面プログラムの登録 */
lcsUI.config([
             {map: ROOTDIR + '/src/ini/gmap.json'},
             {frame: [
                 {jp: ROOTDIR + '/src/ini/i18n/jp/gframenavi.json'},
             ...
             {tags: [
                 {jp: ROOTDIR + '/src/ini/i18n/jp/gpagetags.json'},
                 {kr: ROOTDIR + '/src/ini/i18n/kr/pagetags.json'},
                 {en: ROOTDIR + '/src/ini/i18n/en/pagetags.json'},
                 {ch: ROOTDIR + '/src/ini/i18n/ch/pagetags.json'}
             ]}
]);
...
var server = http.createServer(app).listen(PORT, function() {
    lcsAp.syslog('info',
                 {'Mike server(node v0.8.14) listening on port ': PORT,
